<template>
  <li class="h-timeline-item" :class="{ [`h-timeline-item-center`]: center }">
    ...
    <div class="h-timeline-item-wrapper">
      <div v-if="!hideTimestamp && placement === 'top'" class="h-timeline-item-timestamp h-timeline-item-top">
        {{ timestamp }}
      </div>
      ...
      <div v-if="!hideTimestamp && placement === 'bottom'" class="h-timeline-item-timestamp h-timeline-item-bottom">
        {{ timestamp }}
      </div>
    </div>
  </li>

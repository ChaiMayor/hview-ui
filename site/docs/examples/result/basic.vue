<template>
  <div class="container">
    ...
    <div class="item">
      <h-result icon="warning" title="Warning Tip" sub-title="Please follow the instructions">
        <template #extra>
          <h-button type="primary">Back</h-button>
        </template>
      </h-result>
    ...
    <div class="item">
      <h-result icon="error" title="Error Tip" sub-title="Please follow the instructions">
        <template #extra>
          <h-button type="primary">Back</h-button>
        </template>
      </h-result>
